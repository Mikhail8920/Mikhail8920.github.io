    ...
    document.querySelector("#menu__toggle").onclick = function change2() {
        ...
        if ((document.querySelector(".header__menu").style.visibility == "hidden") && (off.checked == true)) {
            document.querySelector(".header__menu").style.visibility = "visible";
        } else if ((document.querySelector(".header__menu").style.visibility == "visible") && (off.checked == false)) {
